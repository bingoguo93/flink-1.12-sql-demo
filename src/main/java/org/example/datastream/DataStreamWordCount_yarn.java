...
public class DataStreamWordCount_yarn {
    ...
    public static void main(String[] args) throws Exception {
        ...
        result.writeAsText("hdfs://cdh6.com:8020/tmp/wordcount_"+System.currentTimeMillis() + System.currentTimeMillis()).setParallelism(1);
